...
class Spam(datajanitor.DataJanitor):
    """
    Spam dataset from UCI Archive.

    Classify an email as spam or not spam based on frequency of words and
    other text traits.
